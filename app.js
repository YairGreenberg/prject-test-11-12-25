...
while (bool) {
  ...
  switch (inputSelect) {
    case 1:
      let choiceNameOrId = raedlaine.question(
        "Choose whether to search by ID or name?\n"
      );
      ...
      break;
    case 2:
      let aboveOrBelow = raedlaine.question(
        "Which stocks would you like to see Above or Below a certain price?\n"
      );
      ...
      break;
    case 3:
      let buyOrSell = raedlaine.question(
